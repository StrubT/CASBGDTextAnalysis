...
public class Configuration implements Serializable {
	...
	// define how many of the top n words to use for the similarity calculation (improves speed and result)
	public static final int TOP_N_WORDS_4_SIMILARITY = 100;

	// result
	public static final String RESULT = "ds.dat";
}
